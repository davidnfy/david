      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 gap-12 md:gap-20">
          {projects.map((project, index) => (
            ...
            >
              <div className="md:col-span-7 relative overflow-hidden rounded-2xl aspect-video cursor-pointer" onClick={(e) => handleClick(project.githubUrl, e)}>
                <motion.img
                  src={project.image.startsWith('/') ? project.image : `https://picsum.photos/seed/${project.image}/1200/675`}
                  alt={project.title}
              ...
              <div className="md:col-span-5 flex justify-between items-center">
                <div className="space-y-4">
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] opacity-30">{project.category}</span>
                    <h4 className="text-3xl md:text-5xl font-black tracking-tighter">{project.title}</h4>
                  </div>
                  <div className="flex gap-3">
                  </div>
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 border border-white/20 rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all cursor-pointer" onClick={(e) => handleClick(project.githubUrl, e)}>
